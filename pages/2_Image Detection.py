...
if image_file is not None:
    ...
    for det in detections:
        ...
        font_scale = 0.5  # Further reduced for a more compact text
        font_thickness = 1  # Slightly thinner to avoid boldness
        ...
        text_x, text_y = x1, max(y1 - 5, text_size[1] + 3)  # Adjusted for a tighter fit
        
        cv2.rectangle(annotated_frame, (text_x, text_y - text_size[1] - 2), (text_x + text_size[0] + 3, text_y + 2), bbox_color, -1)
        cv2.putText(annotated_frame, label_text, (text_x, text_y), font, font_scale, (0, 0, 0), font_thickness + 1)  # Black outline
